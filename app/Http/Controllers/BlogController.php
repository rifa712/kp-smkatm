...
class BlogController extends Controller
{
    public function index(Posts $post){
        ...
        return view('blog',compact('data','tag_widget','category_widget'));
    }
    ...
    public function isi_blog($slug){
        ...
        return view('blog.isi_post',compact('data','tag_widget','category_widget'));
    }
    ...
    public function list_blog(){
        ...
        return view('blog.list_post',compact('data','tag_widget','category_widget'));
    }
